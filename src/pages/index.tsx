...
import { GPT_35_TURBO, DEFAULTAPIKEY } from "../utils/constants";
              ...
              <Expand delay={1.2}>
                <Input
                  ...
                  left={
                    <>
                      <FaRobot />
                      <span className="ml-2">角色:</span>
                    </>
                  }
                  value={name}
                  disabled={agent != null}
                  onChange={(e) => setName(e.target.value)}
                  placeholder="例如:高級前端工程師"
                />
              </Expand>
              <Expand delay={1.3}>
                <Input
                  left={
                    <>
                      <FaStar />
                      <span className="ml-2">目標:</span>
                    </>
                  }
                  disabled={agent != null}
                  value={goalInput}
                  onChange={(e) => setGoalInput(e.target.value)}
                  placeholder="例如:產生一個登入頁面，使用VUE框架"
                />
              </Expand>
            </div>
