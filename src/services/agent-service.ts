...
export async function startAgent(modelSettings: ModelSettings,name:string, goal: string) {
  const completion = await startGoalAgent(createModel(modelSettings), name, goal);
